...
| 7 (10/12) | **Classification II,** including regularization and dimension reduction.<br />Reading: ["The curse(s) of dimensionality"](https://www.nature.com/articles/s41592-018-0019-x)| **No class** (fall break) | Mini-project: Classifying novels (continued)|
